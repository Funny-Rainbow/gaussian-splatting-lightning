...
@dataclass
class BackgroundRemovalWithInverseDepthMetrics(HasInverseDepthMetrics):
    ...
    def instantiate(self, *args, **kwargs):
        return BackgroundRemovalWithInverseDepthMetricsModule(self)


class BackgroundRemovalWithInverseDepthMetricsModule(HasInverseDepthMetricsModule):
